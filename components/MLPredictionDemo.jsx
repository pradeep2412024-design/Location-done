...
const MLPredictionDemo = () => {
  ...
  const [predictionType, setPredictionType] = useState('comprehensive_analysis');
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="space-y-4">
                {predictions.result.predictions && (
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <div className="text-2xl font-bold text-blue-600">
                      {predictions.result.predictions.ensemble_yield} tons/hectare
                    </div>
                    {predictions.result.predictions.confidence_interval && (
                      <div className="text-sm text-blue-700 mt-1">
                        Confidence: {predictions.result.predictions.confidence_interval.lower} - {predictions.result.predictions.confidence_interval.upper} tons/hectare
                      </div>
                    )}
                  </div>
                )}
                ...
                {predictions.result.recommendations && (
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                      {predictions.result.recommendations.slice(0, 3).map((rec, index) => (
                ...
                {predictions.result.analysis_summary && (
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-purple-900 mb-2">📊 Analysis Summary</h3>
                    <p className="text-purple-700">{predictions.result.analysis_summary}</p>
                  </div>
                )}
